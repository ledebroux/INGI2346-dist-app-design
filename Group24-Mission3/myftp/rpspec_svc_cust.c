...
prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case RPWD:
		...
		local = (char *(*)(char *, struct svc_req *)) rpwd_1_svc;
		break;

	case RCD:
		_xdr_argument = (xdrproc_t) xdr_wrapstring;
		_xdr_result = (xdrproc_t) xdr_int32_t;
		local = (char *(*)(char *, struct svc_req *)) rcd_1_svc;
		break;
	...
	case RGET:
		_xdr_argument = (xdrproc_t) xdr_file_desc;
		_xdr_result = (xdrproc_t) xdr_file_part;
		local = (char *(*)(char *, struct svc_req *)) rget_1_svc;
		break;
